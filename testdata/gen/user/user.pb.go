...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x07, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x36, 0x0a, 0x11, 0x43,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x32, 0x92, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12,
	0x17, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70,
...
var file_user_user_proto_goTypes = []interface{}{
	...
	(*CreateUserResponse)(nil), // 3: example.CreateUserResponse
	(*User)(nil),               // 4: example.User
}
var file_user_user_proto_depIdxs = []int32{
	4, // 0: example.GetUserResponse.user:type_name -> example.User
	4, // 1: example.CreateUserRequest.user:type_name -> example.User
	0, // 2: example.UserService.GetUser:input_type -> example.GetUserRequest
	2, // 3: example.UserService.CreateUser:input_type -> example.CreateUserRequest
	1, // 4: example.UserService.GetUser:output_type -> example.GetUserResponse
	3, // 5: example.UserService.CreateUser:output_type -> example.CreateUserResponse
